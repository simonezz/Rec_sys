...
characters = {
    ...
    "th_char": "กขคฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรลวศษสหฬอฮฤ"
    + "เแโใไะา"
    + special_c
    + "ํฺ"
    + "ฯๆ",
...
model_url = {
    ...
    "bengali.pth": (
        ...
        "cea9e897e2c0576b62cbb1554997ce1c",
    ),
    "telugu.pth": (
        "https://github.com/JaidedAI/EasyOCR/releases/download/v1.2/telugu.zip",
        "f7576012a3abe593950c47bfa1bd8ddc",
    ),
    "kannada.pth": (
        "https://github.com/JaidedAI/EasyOCR/releases/download/v1.21/kannada.zip",
        "c240c97e4adb8773b53b3b3dec728627",
    ),
}
