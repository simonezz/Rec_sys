...
class VideoApi(RemoveableBulkModuleApi):
    ...
    def _download(self, id, is_stream=False):
        ...
        """
        response = self._api.post(
            "videos.download", {ApiField.ID: id}, stream=is_stream
        )
        return response
    ...
    def download_range_by_id(self, id, frame_start, frame_end, is_stream=True):
        ...
        return self.downalod_range_by_path(
            path_original, frame_start, frame_end, is_stream
        )

    def downalod_range_by_path(
        self, path_original, frame_start, frame_end, is_stream=False
    ):
        """
    ...
    def notify_progress(
        self, track_id, video_id, frame_start, frame_end, current, total
    ):
        """
        :param track_id: int
        :param video_id: int
