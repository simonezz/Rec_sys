...
class KeyIndexedCollection:
    ...
    def __contains__(self, item):
        return isinstance(
            item, KeyIndexedCollection.item_type
        ...
        for other_item in other:
            ...
            if our_item is not None:
                if our_item != other_item:
                    raise ValueError(
                        "Different values for the same key {!r}".format(
                            other_item.key()
                        )
                    )
                else:
    ...
    def merge(self, other):
        ...
        for other_item in other.items():
            ...
            if our_item is None:
                ...
                raise ValueError(
                    "Error during merge for key {!r}: values are different".format(
                        other_item.key()
                    )
                )
...
class MultiKeyIndexedCollection(KeyIndexedCollection):
    ...
    def __contains__(self, item):
        return isinstance(
            item, MultiKeyIndexedCollection.item_type
